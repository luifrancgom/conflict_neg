...
\hypersetup{
  pdftitle={Strategy and Tactics of Integrative Negotiation and Three-Party Coalition Exercise Round 1},
...
\item
  ...
  2024, chap. 3}) and
  (\citeproc{ref-program_on_negotiation_three_2008}{Program on
  Negotiation 2008})
\end{itemize}
\end{frame}
...
\item
  ...
  \tightlist
  \item
    Primer corte 30\% \textgreater{} Learning Activities \textgreater{}
...
\item
  ...
  \item
    ...
    are (\citeproc{ref-lewicki_negociacion_2024}{Lewicki, Barry, and
    Saunders 2024}, p 74-91):
    ...
    \item
      Understand the problem by identifying the interests and needs of
      the other parties\footnote<.->{A good illustration of this aspect
        is the example of the library pointed out in
        (\citeproc{ref-lewicki_negociacion_2024}{Lewicki, Barry, and
        Saunders 2024}, p 78)}
    \item
...
\includegraphics[width=0.85\textwidth,height=\textheight]{003_stra_tac_integra_round_1_files/figure-beamer/fig-creating-claiming-value-pareto-efficient-frontier-1.pdf}
...
\begin{itemize}
\item
  Objective outcomes (\citeproc{ref-lewicki_negociacion_2024}{Lewicki,
  Barry, and Saunders 2024}, p 91)
  ...
  \end{itemize}
\item
  Subjective outcomes (\citeproc{ref-curhan_what_2006}{Curhan,
  Elfenbein, and Xu 2006}, p 501)
...
\item
  ...
  Saunders 2024}, p 92-97) 7 factors that generate a predisposition to
...
\bibitem[\citeproctext]{ref-curhan_what_2006}
...
\bibitem[\citeproctext]{ref-program_on_negotiation_three_2008}
