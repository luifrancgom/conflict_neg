...
- **Purpose**
    ...
    - Understand the core elements of distributive negotiation scenarios, along with the specific strategies and tactics applied in this context.
...
dist_neg1 |>
  ...
  geom_label_repel(
    aes(x = x, y = y, label = label_text, fill = negotiator),
    color = "white",
    alpha = 0.9,
    parse = TRUE,
    show.legend = FALSE,
  ...
  scale_x_continuous(
    breaks = dist_neg1$x,
    labels = label_number(prefix = "$", suffix = "K", accuracy = 1)
  ) +
...
# Data
dist_neg4 <- tibble(
  x = c(130, 133, 134, 135, 140, 142, 145, 150),
  y = rep(x = 0, times = 8),
  negotiator = c(
    "Sofia",
    "Jackson",
