...
- Example of a distortion in perception know as __Checker Shadow illusion__ [@adelson_checkershadow_1995]

```{r, out.width="100%"}

include_graphics(path = "005_checkershadow_double_full.jpg")
```

# Perception

- Example of a distortion in perception know as __Sander's parallelogram__ [@luckiesh_visual_2017]

```{r, out.width="100%"}

include_graphics(path = "005_sander_Illusion.png")
```

# Perception

- Example of a distortion in perception know as __Müller-Lyer Illusion__ [@zeman_muller-lyer_2013]

```{r, out.width="80%"}

include_graphics(path = "005_muller_lLyer_circle.png")
```
...
- Example of how __framing__ can change decisions depending on how information is presented [@tversky_framing_1981, p 453]:
    ...
    + __Problem 2__ [N = 152][^4]: The same statement as __Problem 1__
