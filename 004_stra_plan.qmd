...
```{r }
#| out-width: 90%
#| fig-cap: Relationship between key steps in the planning Process [@lewicki_essentials_2016, Chapter 4, p 90]
...
```{r }
#| out-width: 85%
#| fig-cap: Different engagement strategies in a negotiation context  [@lewicki_essentials_2016, Chapter 4, p 94, Table 4.1]
...
```{r }
#| out-width: 90%
#| fig-cap: Key steps in the planning process [@lewicki_essentials_2016, Chapter 4, p 96-112]
...
- To the __[R Core Team](https://www.r-project.org/contributors.html)__, the creators of __[RStudio IDE](https://rstudio.com/products/rstudio/)__, __[Quarto](https://quarto.org/)__ and the authors and maintainers of the packages __[DiagrammeR](https://CRAN.R-project.org/package=DiagrammeR)__, __[tufte](https://CRAN.R-project.org/package=tufte)__, and __[tinytex](https://CRAN.R-project.org/package=tinytex)__ for allowing me to access these tools without paying for a license
