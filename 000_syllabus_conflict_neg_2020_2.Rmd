...
- __Virtual classroom__

    + An invitation will be send to your institutional account
    
    + Please use your institutional account to accept the invitation

- __Communication through the virtual classroom__

    + Every Friday between 19:30 hours and 20:30 hours: 
    
        + Tablon > Enlace de Meet
    
    + Doubts and concerns of the topics of the course, please send me an email to __luis.gomezl@unimilitar.edu.co__
    
    + Complaints regarding grades, please send an email to __luis.gomezl@unimilitar.edu.co__
    
        + To make any complaints, you are asked to wait first for the grades to be published and to be made based on the the evaluation parameters
...
- Semester: 8
- Block: 2 (September 21 – November 21, 2020) 
...
tibble(Week = c("1","2","3", "3", "4", "5", "6", "6", "7", "8", "9", "9"),
       Material        = rep(c(lewicki, 
                               "[@program_of_negotiation_three_2008]"), 
                             times = 3),
...
- September 22
    ...
    + __Virtual meeting Presentation Syllabus__
        ...
        + __Prerequisites__:
            + Review the course program in advance, which can be downloaded by following the route _Primer corte 30% > Support material - Primer corte 30% > 000_syllabus_conflict_neg_2020_2_
...
- October 5 
    ...
    + __Instructions Opening Midterm Exam Three Party Coalition Exercise Round 1__
        + __Opening time__: 00:00 hours
        + __Prerequisites__:
            + Read and review role play instructions [@program_of_negotiation_three_2008]
...
- __Primer corte__: 30%
    ...
    + __Questionnaire 1__: 10% 
    + __Midterm Exam Three Party Coalition Exercise Round 1__: 20% 

- __Segundo corte__: 30%

    + __Questionnaire 2__: 10% 
    + __Midterm Exam Three Party Coalition Exercise Round 2__: 20%

- __Tercer corte__: 40%

    + __Questionnaire 3__: 10%
    + __Final Exam Three Party Coalition Exercise Modified__: 30 %
...
- [@lewicki_essentials_2016, Chapters 1, 2, 3, 4, 6, 7, 8, 5 & 12]
    ...
    + The book can be consulted through the virtual classroom where an invitation will be send to your institutional account
    
- [@program_of_negotiation_three_2008]

    + The document can be consulted through the virtual classroom where an invitation will be send to your institutional account
