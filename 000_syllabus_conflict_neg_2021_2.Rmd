...
- __Communication through the virtual classroom__
    ...
    + Complaints regarding grades, please send an email to __luis.gomezl@unimilitar.edu.co__
        ...
        + Urgent issues, you can call me to +57 3124541536 Monday, Tuesday, Wednesday, Thursday and Friday between 14:00 hours and 16:00 hours. Please do not send me whatsapp messages or call me on weekends.
...
- Semester: 8
- Block: 2 (September 27 – November 24, 2021) 
...
- Specific competencies:
    ...
    + Lead the human talent by solving conflicts in a strategic way to achieve the common objectives of the organization. 
...
- September 27
    ...
    + __Virtual meeting Presentation Syllabus__
        ...
        + __Prerequisites__:
            + Review the course program in advance, which can be downloaded by following the route _Primer corte 30% > Learning Resources > Support material > Presentations > 000_syllabus_conflict_neg_2021_2_
...
- October 16
    ...
    + __Midterm Exam Three Party Coalition Exercise Round 1__
        + __Opening time__: 13:00 hours
        + __Closing time__: 15:00 hours
        + __Prerequisites__: 
            + Read and review role play instructions [@program_on_negotiation_three_2008]
            + Read and review [@lewicki_essentials_2016, Chapter 3]
            + Have a headset with a built-in microphone to isolate noise from the environment
...
- __Primer corte__: 30%
    ...
    + __Questionnaire 1__: 20% 
    + __Midterm Exam Three Party Coalition Exercise Round 1__: 10% 

- __Segundo corte__: 30%

    + __Questionnaire 2__: 20% 
    + __Midterm Exam Three Party Coalition Exercise Round 2__: 10%

- __Tercer corte__: 40%

    + __Questionnaire 3__: 20%
    + __Final Exam Three Party Coalition Exercise Modified__: 20 %
