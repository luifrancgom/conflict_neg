...
![Checker Shadow illusion [@adelson_checkershadow_1995]](005_checkershadow_double_full.jpg){#fig-checker_shadow_illusion fig-alt="Checker Shadow illusion" fig-align="center" width="400px" height="400px"}

# Perception

- Example of a distortion in perception

![Sander's parallelogram [@luckiesh_visual_2017]](005_sander_Illusion.png){#fig-sanders_parallelogram fig-alt="Sander's parallelogram" fig-align="center" width="400px" height="400px"}

# Perception

- Example of a distortion in perception

![Müller-Lyer Illusion [@zeman_muller-lyer_2013]](005_muller_lLyer_circle.png){#fig-muller_lyer_illusion fig-alt="Müller-Lyer Illusion" fig-align="center" width="300px" height="300px"}
...
- Positive emotions and positive consequences for negotiations [@lewicki_essentials_2016, p 157-158]:
...
- Aspects of the negotiation process and positive emotions [@lewicki_essentials_2016, p 159]:
...
- To the __[R Core Team](https://www.r-project.org/contributors.html)__, the creators of __[RStudio IDE](https://rstudio.com/products/rstudio/)__ and the authors and maintainers of the packages __[DiagrammeR](https://CRAN.R-project.org/package=DiagrammeR)__, __[knitr](https://CRAN.R-project.org/package=knitr)__, and __[tinytex](https://CRAN.R-project.org/package=tinytex)__ for allowing me to access these tools without paying for a license
